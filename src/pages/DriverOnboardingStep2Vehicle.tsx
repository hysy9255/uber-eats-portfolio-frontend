...
export default function DriverOnboardingVehicle() {
  ...
  const defaultValues = loadDraft<IDriverOnBoardingStep2Form>(
    DRIVER_STEP2_KEY,
    {
      vehicleType: "car",
      model: "",
  ...
  const methods = useForm<IDriverOnBoardingStep2Form>({
    mode: "onChange",
    defaultValues,
  });

  const onContinue = (data: IDriverOnBoardingStep2Form) => {
