...
const OpenTimeSelectComp: React.FC<OpenTimeSelectCompProps> = ({
  day,
  renderValue = "Choose Time",
}) => {
  const { hours, isEditing, handleClickDropdown, setOpenTime, isDropdownOpen } =
    useOperatingHours();
...
export default OpenTimeSelectComp;
