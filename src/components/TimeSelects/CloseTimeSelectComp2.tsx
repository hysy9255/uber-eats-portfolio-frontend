...
interface CloseTimeSelectComp2Props {
  day: Day;
  renderValue?: string;
}

const CloseTimeSelectComp2: React.FC<CloseTimeSelectComp2Props> = ({
  day,
  renderValue = "Choose Time",
}) => {
  const { hours, handleClickDropdown, setCloseTime, isDropdownOpen } =
...
export default CloseTimeSelectComp2;
