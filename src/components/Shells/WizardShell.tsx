...
export default function WizardShell({
  ...
  return (
    ...
    <GlobalLayout>
      <MainHeaderV2
        help={<HelpHeader />}
        // layoutWidth={`${layoutWidth} px-6 lg:px-10`}
      />
      ...
      >
        {/* Progress */}
        {/* <div className="sticky top-[57px] z-30 bg-gray-50 py-4 -mx-6 lg:-mx-10"> */}
        ...
        <div className="sticky bottom-0 mt-10 -mx-6 lg:-mx-10 bg-white/80 backdrop-blur border-t border-black/5">
          <div className="mx-auto max-w-screen-2xl px-6 lg:px-10 py-4 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              <button className="rounded-full px-4 py-2 text-sm font-medium text-slate-700 hover:underline hover:cursor-pointer">
                Save & exit
              </button>
              <button
