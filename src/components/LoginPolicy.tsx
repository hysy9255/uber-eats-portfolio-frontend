...
const LoginPolicy = () => {
  return (
    ...
    //   <div className="border-t border-slate-200 pt-4 text-[12px] leading-relaxed text-slate-500">
    //     <p>
    ...
    // <div className="mt-auto pt-6">
    //   <div className="relative overflow-hidden rounded-2xl bg-white/80 backdrop-blur ring-1 ring-black/10">
    //     {/* 상단 컬러 액센트 바 */}
    //     <div className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-emerald-400 via-emerald-500 to-blue-500" />

    //     <div className="p-4 sm:p-5 flex gap-3">
    //       {/* 아이콘 뱃지 */}
    //       <div className="mt-0.5 flex h-9 w-9 items-center justify-center rounded-full bg-emerald-50 ring-1 ring-emerald-100">
    //         <svg
    ...
    //           <a
    //             href="/help"
    //             className="inline-flex items-center rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-medium hover:bg-slate-200"
    //           >
    //             Help Center
    //           </a>
    //           <a
