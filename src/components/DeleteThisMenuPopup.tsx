type DeleteThisMenuPopupProps = {
  onClickCancel: () => void;
  onClickDeleteOk: () => void;
  menuToDelete: string | null;
};

const DeleteThisMenuPopup: React.FC<DeleteThisMenuPopupProps> = ({
  onClickCancel,
  onClickDeleteOk,
  menuToDelete,
}) => {
    ...
    >
      ...
      <div className="relative mx-4 w-full max-w-md rounded-2xl bg-white p-5 shadow-xl ring-1 ring-black/10">
        ...
        <p className="mt-2 text-sm text-slate-600">
          ...
          <span className="font-semibold text-black">{menuToDelete}</span>? This
