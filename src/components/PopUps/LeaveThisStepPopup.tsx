...
const LeaveThisStepPopup = ({ setShowConfirm, onExit }: PopupProps) => {
  return (
    <div
    ...
    >
      ...
      <div className="relative mx-4 w-full max-w-md rounded-2xl bg-white p-5 shadow-xl ring-1 ring-black/10">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Are you sure you want to exit? If you exit, the information you typed
          will be lost.
        </p>
        ...
        <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:justify-end">
          ...
          <button
            ...
            className="hover:cursor-pointer rounded-full px-4 py-2 text-sm font-medium text-red-600 ring-1 ring-red-200 hover:bg-red-50"
          >
            Exit
          </button>
        </div>
